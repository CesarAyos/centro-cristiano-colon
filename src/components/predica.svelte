<script>
  ...
  <div class="container" style="background: #1b1b1b;">
    <div class="row row-cols-1 row-cols-md-4">
      {#each video as item}
        <div class="col mb-4 p-1">
          <div class="card p-2" style="width: 18rem; border: none;background:#1b1b1b;">
            <p style="color:#92ae80;"><em>{item.Titulo}  <br> {item.Fecha}</em></p>
            <iframe
            ...
            ></iframe>
            <div class="card-body">
              <p style="color:#92ae80;"><em>{item.Pastor}</em></p>
              <p></p>
            </div>
          </div>
        </div>
